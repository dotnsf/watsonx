...
app.post( '/api/generate_text', async function( req, res ){
  ...
  var apikey = ( req.body.apikey ? req.body.apikey : env_apikey );
  var project_id = ( req.body.project_id ? req.body.project_id : env_project_id );
  var model_id = ( req.body.model_id ? req.body.model_id : env_model_id );
